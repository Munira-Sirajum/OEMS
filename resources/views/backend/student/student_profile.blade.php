								...
								<div class="card">
									<div class="text-center p-3 overlay-box" style="background-image: url(images/big/img1.jpg);">
										<div class="profile-photo">
											<img src="{{ asset('/') }}backend/images/profile/user.png" width="100" class="img-fluid rounded-circle" alt="">
										</div>
										<h3 class="mt-3 mb-1 text-white">{{$students->name}}</h3>
										<p class="text-white mb-0">{{$students->department}}</p>
									</div>
                                            ...
                                            <div id="about-me" class="tab-pane fade active show">
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{$students->name}} </span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{$students->email}}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{$students->mobile_number}}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span>{{$students->department}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
